...
<body>
        ...
        <div class="container1">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                  <div class="dropdown">
                  <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown">Menu Opções</span></button>
                    <ul class="dropdown-menu">
                        ...
                        <?php endif; ?>
                            <li><a href="fechados.php?logouf=">Sair</a></li>
                    </ul>
  ...
  <div id="demo">
    ...
    <form method="get" class="todos">
        ...
        <input type="hidden" name="fechados" />
    </form>
    </div>
  <div class="titulo">
